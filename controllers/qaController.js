...
//     const prompt = `
// You are an AI assistant. Based on the following document, answer the user's question and provide the most relevant part of the document as context.
// ---
// Document:
// ${context}
// ---
...
`;
    ...
    // Save the question, answer, and context to the document's queryHistory
